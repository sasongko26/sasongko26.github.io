...
tags: [pkgtool]
---
_Open source software (OSS)_ diadakan salah satunya untuk memudahkan hidup. **Slackware** pun demikian. Patrick J Volkerding, pengembang **slackware** memberikan kebebasan kepada _slackers_ untuk memilih manajer paket yang akan digunakan. **Slackware** mempunyai 2 manajer paket, yaitu `slackpkg` dan `pkgtool`. Pengenalan `slackpkg` sudah ada di [catatan sebelumnya]({% post_url 2026-04-19-mengenal-slackpkg %}).
